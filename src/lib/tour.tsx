...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    target: 'measures',
    title: 'Заміри тіла',
    body: 'Внесіть вагу й обхвати — це стартова точка. Оновлюйте їх хоча б раз на тиждень: саме з цих записів будується прогрес.',
  },
  {
    id: 'ration',
  ...
  },
  {
    ...
    target: 'home-card',
    title: 'Головна',
    body: 'Тут усе разом: кільця за сьогодні й графіки за тиждень. Вони рухаються від ваших записів — не забувайте про щотижневі заміри.',
  },
]
